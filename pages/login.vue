...
const submitForm = (event: any) => {
  ...
  const res = $fetch(`${api}/authentication`, {
    method: 'POST',
    body: {
  ...
  <div class="form">
    ...
    <div class="form">
      <div class="form_group">
        ...
        <ul class="form_group-errors" v-if="state.formErrors != []">
